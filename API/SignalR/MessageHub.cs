...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        {
            // Make groups of 2 users (chatting)
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            var sender = await _userRepository.GetUserByName_Async(username);
            var recipient = await _userRepository.GetUserByName_Async(createMessageDto.RecipientUsername);
        ...
        {
            // Group name in alphabetical order
